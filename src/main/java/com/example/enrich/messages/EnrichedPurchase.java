...
public record EnrichedPurchase(
        ...
        @JsonProperty("transaction") EnrichedTransaction transaction
    ...
    public record EnrichedTransaction(
            ...
            @JsonProperty("sale_items") List<EnrichedSaleItem> saleItems,
            @JsonProperty("return_items") List<EnrichedSaleItem> returnItems,
            @JsonProperty("tender") List<Tender> tender,
            @JsonProperty("payload") String payload
    ) {

        public record EnrichedSaleItem(
                ...
                @JsonProperty("property") Integer newProperty
        ) {
